...
function getTheTags() {
    return [
        "All", "Django", "Deep Learning", "Android", "Kotlin"
    ]
}
...
function getPastExperienceData() {
    return [{
        ...
        'company_name': 'Greedy Game',
        'role_title': 'Android Developer Intern, March 2021 to July 2021 ',
        'description': ['Worked as an Android developer, worked on multiple projects and build projects from scratch from ideation to deployment. Worked in Koltin, node-js and other tech stack to get work done'
            , 'I worked on the android App, and implemented it with clean architecture in mind, and wrote test cases as well.'],
        'link': "https://greedygame.com/"
    },
        {
